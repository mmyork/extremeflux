...
* **Update**: I have rewritten this function to do what is desired. Now, each day of the year is determined as active/inactive if the average GPP over the previous week daily averages is above the 30th percentile for that site. Then, one growing season is defined from the first day that is considered to the last day. I will be testing this on sites and looking for errors before continuing.
