#!/bin/bash
#SBATCH --job-name=inactive.in                     # the name of your job
#SBATCH --output=/scratch/my464/cflux/code2/inactive.in.txt    # this is the file your output and errors go to
