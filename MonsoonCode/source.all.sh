#!/bin/bash
#SBATCH --job-name=source.all                     # the name of your job
#SBATCH --output=/scratch/my464/cflux/code2/source.all.txt    # this is the file your output and errors go to
