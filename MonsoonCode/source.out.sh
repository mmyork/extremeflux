#!/bin/bash
#SBATCH --job-name=source.out                     # the name of your job
#SBATCH --output=/scratch/my464/cflux/code2/source.out.txt    # this is the file your output and errors go to
