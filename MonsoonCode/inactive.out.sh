#!/bin/bash
#SBATCH --job-name=inactive.out                     # the name of your job
#SBATCH --output=/scratch/my464/cflux/code2/inactive.out.txt    # this is the file your output and errors go to
